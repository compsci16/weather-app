...
function getCurrentWeather(cityName) {
  return fetch("http://api.openweathermap.org/data/2.5/weather?q=".concat(cityName, "&appid=").concat(API_KEY)).then(function (res) {
    return res.json();
  }).then(function (data) {
...
function fetchCoords(cityName) {
  return fetch("http://api.openweathermap.org/geo/1.0/direct?q=".concat(cityName, "&appid=").concat(API_KEY)).then(function (response) {
...
function iconSetter(img, name) {
  img.src = "http://openweathermap.org/img/wn/".concat(name, "@2x.png");
}
